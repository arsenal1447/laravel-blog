@extends('backendzxx.content.common')
        ...
        <div class="panel panel-default">
            ...
            @endif
                ...
                <div class="panel-body">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if($commentInfo->parent_id != 0)
                                    <a href="{{ url(route('backendzxx.comment.show',['id'=>$commentInfo->parent_id])) }}" target="_blank" >点击查看</a>
                                @endif
                            </td>
                        </tr>
                        <tr>
                    ...
                    <a href="{{ url(route('backendzxx.comment.create',['id'=>$commentInfo->id])) }}" target="_blank" class="btn btn-info" >
                        点击回复
                    </a>
                </div>
